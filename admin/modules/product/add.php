            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <!-- Begin form add product -->
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Mô Tả Hàng Hóa</label>
...
if(@$_FILES['Hinh']['error'] == 0){
    if(move_uploaded_file(@$_FILES['Hinh']["tmp_name"], "img_product/".@$_FILES['Hinh']["name"]))
        {
            $sql = "INSERT INTO `product` (`id`, `name`, `slug`, `soluong`, `gia`, `sale`, `avatar`, `category`,`content`, `created_at`, `updata_up`) 
            VALUES (NULL, '{$_REQUEST['TenSP']}', NULL,'{$_REQUEST['soluong']}', '{$_REQUEST['Gia']}', '{$_REQUEST['GiamGia']}', '{$_FILES['Hinh']['name']}', '{$_REQUEST['loaisp']}', '{$_REQUEST['noidung']}',current_timestamp() , current_timestamp())";
            echo $sql;
