                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="/DoAnWeb2020/admin/modules/admins"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Chi Tiết Hóa Đơn</span></a></li>
                                <li><a title="Dashboard v.2" href="/DoAnWeb2020/admin/modules/category"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Quản Lý Hóa Đơn</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Blog Details" href="blog-details.html"><i class="fa fa-tags sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Tra Cứu Thông Tin</span></a></li>
                                ...
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Khách Hàng <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="/DoAnWeb2020/admin/modules/admins">Sản Phẩm Đã Mua</a></li>
                                                <li><a href="/DoAnWeb2020/admin/modules/category">Kiểm Tra Hóa Đơn</a></li>
                                                <li><a href="/DoAnWeb2020/admin/modules/type">Tra Cứu Thông Tin</a></li>
